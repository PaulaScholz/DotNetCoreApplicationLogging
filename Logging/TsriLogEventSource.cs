...
{
    /// <summary>
    /// Provides a source for diagnostic messages from TsriLib technologies to external listeners.
    /// </summary>
    [EventSource(Name = EVENT_SOURCE_NAME)]
    sealed public class TsriLogEventSource : EventSource
    {
        private const string EVENT_SOURCE_NAME = "TsriLog";

        /// <summary>
        /// Initializes a new instance of the <see cref="LogSource"/> class.
        /// </summary>
        private TsriLogEventSource()
        ...
        /// </summary>
        public static TsriLogEventSource Instance
        { get; } = new TsriLogEventSource();
